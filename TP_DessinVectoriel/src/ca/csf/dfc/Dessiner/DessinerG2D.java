...
public class DessinerG2D implements IDessiner{
	...
	@Override
	public void dessinerLigne(int p_x1, int p_y1, int p_x2, int p_y2, Couleur couleurTrait, float epaisseurTrait) {
		if (couleurTrait != null) {
			m_g2D.setPaint(new Color(
					couleurTrait.getRouge(),
					couleurTrait.getVert(),
					couleurTrait.getBleu(),
					couleurTrait.getAlpha()));
	...
	public void dessinerEllipse(int p_x1, int p_y1, int p_x2, int p_y2,
		...
		if (couleurRemplissage != null) {
			m_g2D.setPaint(new Color(
					couleurRemplissage.getRouge(),
					couleurRemplissage.getVert(),
					couleurRemplissage.getBleu(),
					couleurRemplissage.getAlpha()));
